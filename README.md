...
[![Version](https://img.shields.io/badge/version-v1.1.3-orange.svg)](./taskflowzero.html)

🔗 **[Try it now →](https://sasayan0825.github.io/TaskFlowZero/taskflowzero.html)**

📥 **[ダウンロード →](https://github.com/sasayan0825/TaskFlowZero/releases/latest/download/taskflowzero.html)**
...
| ビュー | 特徴 |
|---|---|
| リスト | マイルストーンでグループ化、ドラッグで並び替え、チェックリスト進捗列 |
| カンバン | ステータス別カード管理 |
| ガント | バーのドラッグで日程調整、イナズマ線対応 |
| バーンダウン | スプリントの進捗を可視化 |
| Wiki | Markdownで仕様書・設計書を管理、プレビュー時自動保存 |
...
### 👤 マイタスク
全プロジェクトを横断して、自分への担当タスク・@メンション・アクティビティを一覧表示します。未確認のメンション数や担当タスク数はサイドバーにバッジで表示されます。
...
### ⏱ 工数入力
コメント欄の「＋ 工数を追加」から**予定工数・実績工数**をコメントと一緒に記録できます。記録した工数はコメント履歴として蓄積されます。
...
| タスク詳細 | Wiki |
| ![バーンダウンチャート](.github/screenshots/burndown.png) | ![マイタスク](.github/screenshots/my_tasks.png) |
| バーンダウンチャート | マイタスク |
...
- **フォント:** Google Fonts — Outfit / Noto Sans JP / JetBrains Mono（取得失敗時はシステムフォントで自動フォールバック）
