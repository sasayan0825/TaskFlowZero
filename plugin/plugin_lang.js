...
[/^ステータスを (<b>.+?</b>) → (<b>.+?</b>) に変更$/, (*, a, b) => `Changed status from ${a} to ${b}`],
// 担当者変更: 担当者を <b>A</b> に変更 （元: <b>B</b>）
[/^担当者を (<b>.+?</b>) に変更（元: (<b>.+?</b>)）$/, (*, a, b) => `Changed assignee to ${a} (was ${b})`],
[/^担当者を (<b>.+?</b>) に変更$/, (*, a) => `Changed assignee to ${a}`],
// 担当者解除: 担当者を解除（元: <b>A</b>）
[/^担当者を解除（元: (<b>.+?</b>)）$/, (*, a) => `Removed assignee (was ${a})`],
// 期限変更: 期限を <b>A</b> → <b>B</b> に変更
[/^期限を (<b>.+?</b>) → (<b>.+?</b>) に変更$/, (*, a, b) => `Changed due date from ${a} to ${b}`],
// 詳細更新
[/^詳細内容を更新$/, () => ‘Updated description’],
// チェックリスト追加: チェックリストに追加: <b>A</b>
[/^チェックリストに追加: (<b>.+?</b>)$/, (*, a) => `Added to checklist: ${a}`],
// チェックリスト削除: チェックリスト削除: <b>A</b>
[/^チェックリスト削除: (<b>.+?</b>)$/, (*, a) => `Removed from checklist: ${a}`],
// チェック付けた: <b>A</b> にチェックを付けた
[/^(<b>.+?</b>) にチェックを付けた$/, (*, a) => `Checked ${a}`],
